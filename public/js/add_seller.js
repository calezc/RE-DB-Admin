...
let addSellerForm = document.getElementById('add-seller-form');
...
addSellerForm.addEventListener("submit", (e) => {
    ...
    xhttp.open("POST", "/add_seller", true);
...
// Creates a single row from an Object representing a single record from Sellers
let addRowToTable = (data) => {

    // Get a reference to the current table on the page and clear it out.
    let currentTable = document.getElementById("seller-table");
    ...
    idCell.innerText = newRow.sellerID;
    ...
    td_edit.innerHTML = `<a href='#' onClick=\"updateSeller(${newRow.sellerID})\">Edit</a>`;
    td_delete.innerHTML = `<a href='#' onclick=\"deleteSeller(${newRow.sellerID})\">Delete</a>`;
    ...
    row.setAttribute('sellerFirstName', newRow.firstName);
    row.setAttribute('sellerLastName', newRow.lastName);
    row.setAttribute('sellerEmail', newRow.email);
    row.setAttribute('sellerPhone', newRow.phone);
