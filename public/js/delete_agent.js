...
let deleteAgentForm = document.getElementById('delete-agent-form');

// Modify the objects we need
deleteAgentForm.addEventListener("submit", (e) => {
   
    // Prevent the form from submitting
    e.preventDefault();

    // Get form fields we need to get data from
    let inputAgentID = document.getElementById("delete_agentID");
...
function deleteRow(data) {
    ...
    let delete_row = document.getElementById(`agent-${parsedData}`);
